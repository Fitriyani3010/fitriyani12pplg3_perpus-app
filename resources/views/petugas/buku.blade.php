...
<div class="sidebar">
    ...
    <div class="menu">
        ...
        <a href="/petugas/buku" class="active">
        ...
        <form method="GET">
            ...
            <div class="filter-row">
                ...
                <select name="stok">
                    ...
                    <option value="DESC" {{ request('stok')=='DESC'?'selected':'' }}>Terbanyak</option>
                    <option value="ASC" {{ request('stok')=='ASC'?'selected':'' }}>Terkecil</option>
                </select>
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="{{ route('petugas.buku.destroy',$row->id_buku) }}"
            ...
            @empty
                <tr><td colspan="10">Belum ada data buku.</td></tr>
            @endforelse
...
<div class="modal-overlay" id="modalForm">
    <div class="modal-box">
        ...
        <form method="POST" action="{{ route('petugas.buku.store') }}" enctype="multipart/form-data">
            ...
            <input type="text" name="lokasi" placeholder="Lokassi" required>
...
<div class="modal-overlay" id="modalEdit">
    <div class="modal-box">
        ...
        <form method="POST" action="{{ route('petugas.buku.update') }}" enctype="multipart/form-data">
            @csrf
...
function openEditModal(id, judul, penulis, penerbit, tahun, kategori, stok, lokasi, cover){
    ...
    preview_cover.innerHTML = cover 
        ? "<img src='/uploads/"+cover+"' width='80'>" 
        : "";
}
